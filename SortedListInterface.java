...
public interface SortedListInterface <T extends Comparable<? super T>> {
	 ...
	 * @param newEntry
	 * @return the position (starting with 0) of the entry in 
	 * the list, if the entry belongs to the list;
	 * negative the position - 1 if the entry does not belong
	 * but might be at the position
	 */
